...
We now run a two-sided Pearson chi-square test for testing the association between median of Regular bus Delay Times, and Express bus Delay Times.
```{r echo=FALSE}
