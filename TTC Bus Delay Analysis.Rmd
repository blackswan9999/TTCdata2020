...
author: 'Alice Huang, email: alice9999@protonmail.com'
output:
  html_document:
    df_print: paged
---
...
```{r}
ttc_bus_delays_2020_all$Location = str_replace_all(ttc_bus_delays_2020_all$Location, " W " , " WEST ")
...
ttc_bus_delays_2020_all["Location"][ttc_bus_delays_2020_all["Location"] == "KIOPLING STATION"|
                                      ttc_bus_delays_2020_all["Location"] =="KIPOLING STATION"|
                                      ttc_bus_delays_2020_all["Location"] =="KPLING STATION"|
                                      ttc_bus_delays_2020_all["Location"] =="KPPSN - KIPLING STATION"|
                                      ttc_bus_delays_2020_all["Location"] =="KPSN - KIPLING STATION"|
                                      ttc_bus_delays_2020_all["Location"] =="KIPING STATION"|
...
```{r}
ttc_bus_delays_2020_all$Location = str_replace_all(ttc_bus_delays_2020_all$Location, "VIC PRK" , "VICTORIA PARK")
...
ttc_bus_delays_2020_all["Location"][  ttc_bus_delays_2020_all["Location"] =="YORKMILLS STN"|
                                      ttc_bus_delays_2020_all["Location"] =="YORKMILLS STATION"|
