...
We can see that the standard deviations between the two groups is not the same, since the boxplot for the Collision - TTC group seems to be much shorter than the one for the Collision - Non-TTC group.
