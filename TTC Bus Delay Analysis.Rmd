...
We see that the odds of a regular bus having a delay time greater than the median is nearly 2.98 times that the odds of an express bus having a delay time greater than the median.
...
We now run a two-sided Pearson chi-square test for testing the association between median Eastbound/Westbound bus Delay Times, and Northbound/Southbound bus Delay Times.
