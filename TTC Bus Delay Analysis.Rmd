...
We can see that $\varphi \approx 0.1341457$. We interpret $\varphi = 0.1$ as having a small effect, $\varphi = 0.3$ as having a medium effect, and $\varphi = 0.5$ as having a large effect. Using this scale, bus service type (Regular/Express) has a small effect on delay time being greater than the grand median.   
...
We see that the Phi coefficient is around 0.1176575. We interpret $\varphi = 0.1$ as having a small effect, $\varphi = 0.3$ as having a medium effect, and $\varphi = 0.5$ as having a large effect. Using this scale, bus route direction has a small effect on delay time being greater than the grand median.   
...
We now run a two-sided Pearson chi-square test for testing the association between median TTC Collision bus Delay Times, and Non-TTC Collision bus Delay Times.
...
We see that the Phi coefficient is around 0.6374381. We interpret $\varphi = 0.1$ as having a small effect, $\varphi = 0.3$ as having a medium effect, and $\varphi = 0.5$ as having a large effect. Using this scale, bus route direction has a large effect on delay time being greater than the grand median.   
